document.addEventListener("DOMContentLoaded", function() {
    ...
    const container = document.getElementById('agregarproducto-form-container');
    ...
    var btnAP = document.getElementById("myBtn");
    ...
    DeletProduct.forEach(function(button) {
        button.addEventListener("click", function(event) {
            ...
            if (confirm( "Esta seguro que desea eliminar " + productName + "?")) {
