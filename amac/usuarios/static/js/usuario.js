document.addEventListener("DOMContentLoaded", function() {
    ...
    btnAP.onclick = function() {
        ...
        var form = modalContent.querySelector("usuario_form");
    ...
    DeletProduct.forEach(function(button) {
        button.addEventListener("click", function(event) {
            ...
            var usuarioName = button.getAttribute("data-id");

            if (confirm( "¿Está seguro que desea eliminar el usuario " + usuarioName + "?")) {
